    ...
    <aside className="w-full md:w-96 border-l border-theo-lavanda dark:border-gray-800 bg-theo-lavanda-light dark:bg-gray-900 flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        {benefitRequests.map((benefit) => {
          ...
          return (
            <Card key={benefit.id} className="overflow-hidden border-theo-lavanda dark:border-gray-700 bg-white dark:bg-gray-800 rounded-2xl shadow-theo">
              <div className="p-4">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-gray-900 dark:text-white text-sm mb-1">{benefit.name}</h3>
                    <div className="flex items-center gap-2">
                ...
                {isExpanded && (
                  <div className="space-y-2 mt-4">
                    <Button
                      ...
                      size="sm"
                      className="w-full gap-2 bg-gray-900 dark:bg-gray-700 hover:bg-gray-800 dark:hover:bg-gray-600 text-white h-8 text-xs"
                    >
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="cursor-pointer" onClick={() => toggleExpanded(benefit.id, item.id)}>
                                <div className="flex items-start gap-2">
                                  <span className="font-semibold text-gray-700 dark:text-gray-300 flex-shrink-0">{index + 1}.</span>
                                  <p
                              ...
                              {expandedItemId === item.id && (
                                <div className="mt-2 p-2 bg-gray-100 dark:bg-gray-800 rounded text-gray-700 dark:text-gray-300 leading-relaxed">
                            ...
                            <div className="flex items-center gap-1">
                              <Button
                                ...
                                className="h-6 w-6 p-0 hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:text-blue-600 dark:hover:text-blue-400 flex-shrink-0"
                                title="Precisar de ajuda com esta etapa"
                              >
                                <HelpCircle className="h-3 w-3" />
                              </Button>
                              {item.completed && <CheckCircle2 className="h-4 w-4 text-gray-400 dark:text-gray-500 flex-shrink-0" />}
                            </div>
                          </div>
                        </div>
                      ))}
